...
const routes: Routes = [
  ...
  {
    path: 'encuesta', component: EncuestaComponent, canActivate: [GuardService], children: [
      { path: 'crear', component: EncuestaEdicionComponent, canActivate: [GuardService] },
      { path: 'editar/:id', component: EncuestaEdicionComponent, canActivate: [GuardService]}]
  },
  {
